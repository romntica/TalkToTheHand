...
class RecorderConfig(context: Context) {
    ...
    var maxChunkSizeKb: Int
        ...
        set(value) = prefs.edit().putInt("max_chunk_kb", value).apply()
    ...
    var samplingRate: Int
        ...
        set(value) = prefs.edit().putInt("audio_sampling_rate", value).apply()
    ...
    var isTelemetryEnabled: Boolean
        ...
        set(value) = prefs.edit().putBoolean("telemetry_enabled", value).apply()
